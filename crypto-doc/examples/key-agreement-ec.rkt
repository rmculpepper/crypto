...
;; This example shows derivation of a shared secret using ECDH with
;; curve secp256r1 (aka NIST P-256 aka prime256v1).
...
;; Bob:
(define bob:privkey (generate-private-key 'ec '((curve secp256r1))))
